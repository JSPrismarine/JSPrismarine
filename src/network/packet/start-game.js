...
class StartGamePacket extends DataPacket {
    ...
    encodePayload() {
        ...
        // PMMP states
        this.write(fs.readFileSync(__dirname + '/../../../node_modules/@jsprismarine/bedrock-data/resources/required_block_states.nbt'));

        this.write(this.serializeItemTable(ItemTable));
